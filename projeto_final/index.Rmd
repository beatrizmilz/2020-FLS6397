...
apendice_c <- apendice_c_filtrado %>%
  dplyr::mutate(
    pop_urbana_d = as.double(pop_urbana) ,
    atendimento_coleta_porc_d = as.double(atendimento_coleta_porc),
   atendimento_tratamento_porc_d = as.double(atendimento_tratamento_porc),
   eficiencia_d = as.double(eficiencia),
